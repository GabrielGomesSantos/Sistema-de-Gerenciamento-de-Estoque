...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/styles_read.css">
</head>
<body>
    ...
    <button onclick="window.location='insert.php'">Add produtos</button>
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>
                            ...
                            <td> <a href='delete.php?id=$row[id]'>REMOVER</a></td>
                          </tr>";
                }
            ?>
        </thead>
